...
function plot_graph(g, w=nothing; layout=Spring(), margin=(0.1, 0.1, 0.1, 0.1), kwargs...)
    pos = layout(g)
    ...
    fig = Figure()
    ax = Axis(fig[1, 1])
    pl = graphplot!(ax, g; layout=_ -> pos, ilabels=collect(1:nv(g)), elabels, ilabels_fontsize=50, elabels_fontsize=40, arrow_size=isnothing(w) * 40, kwargs...)
...
Retard d'un voyage :
$$r_v = \max(0, \delta_v) \quad \text{où} \quad \delta_v = \text{ heure d'arrivée réelle } - h_v^a$$
...
[Lien de visualisation](https://tracker.pathfinding.ai/instances?mapId=63761f255d814f08ecdbf3a3&reason=unknown&scenId=63761f265d814f08ecdbf3f5&instanceId=63762a215d814f08ece655a0&solutionId=6411363aa77d7971656050c2&source=submitted)
